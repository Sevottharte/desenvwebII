...
public class OrientadorBean {
	...
	public void salvar() {
		try {
			...
			ex.printStackTrace();
			FacesUtil.adicionarMsgErro("Erro ao tentar incluir um orientador: " +
					ex.getMessage());
		}
	}
	public void excluir() {
		try {
			...
			ex.printStackTrace();
			FacesUtil.adicionarMsgErro("Erro ao tentar excluir um orientador: " +
					ex.getMessage());
		}
	}
	public void editar() {
		try {
			...
			ex.printStackTrace();
			FacesUtil.adicionarMsgErro("Erro ao tentar editar os dados do orientador: " +
					ex.getMessage());
		}
	}
	...
	public void carregar() {
		try {
			...
			ex.printStackTrace();
			FacesUtil.adicionarMsgErro("Erro ao tentar listar os orientadores: " +
					ex.getMessage());
		}
	}
	public void carregarCadastro() {
		try {
			...
			ex.printStackTrace();
			FacesUtil.adicionarMsgErro("Erro ao tentar obter os dados do orientador: " +
					ex.getMessage());
		}
	}
}
